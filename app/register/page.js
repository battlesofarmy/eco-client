...
export default function Register() {
    ...
    const handleSubmit =(e)=>{
        ...
        .then(()=>{
          const createAwishlist = {email : email, products : []};
          axios.post('http://localhost:3000/wishlist/create', createAwishlist)
          .then(()=>setSuccessMsg("Registration Successfull"))
          ...
          <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div style={{marginTop: '15px'}} htmlFor=''>
                ...
                <label htmlFor="terms">
                   I agree with the <Link href={'/'} style={{fontWeight: '500'}} className="font- text-indigo-600 hover:text-indigo-500">terms and conditions</Link>
                </label>
              </div>
